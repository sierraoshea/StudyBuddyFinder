...
urlpatterns = [
    ...
    path('edit_meeting/<int:meeting_id>/update', views.update_meeting, name='update_meeting'),
    path('edit_meeting/<int:meeting_id>/delete', views.delete_meeting, name='delete_meeting'),
